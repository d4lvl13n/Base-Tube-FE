      ...
      <div className="p-2 space-y-1">
        ...
        <div className="w-full group relative">
          ...
          <div className="relative">
            <WalletWrapper
              text="Connect Wallet"
              className="w-full relative flex items-center gap-3 p-3 rounded-lg bg-black hover:bg-black/90 transition-colors"
              onConnect={() => {
            ...
            >
              <div className="text-left transition-transform duration-300 group-hover:translate-x-1">
                ...
                <p className="text-white/50 text-xs group-hover:text-white/70 transition-colors duration-300">Sign in with Web3 wallet</p>
              </div>
            </WalletWrapper>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between h-16 relative">
            ...
            <div className="flex items-center gap-4 shrink-0">
              ...
              <Link to="/" className="flex items-center gap-2 group">
                <div className="relative">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-[#fa7517] to-orange-400 rounded-xl opacity-40 group-hover:opacity-70 blur transition duration-1000 group-hover:duration-200" />
                  <img 
              ...
              >
                ...
                >
                  ...
                  <Button
                    ...
                    className="relative text-white/80 hover:text-white hover:bg-white/5"
                  >
                    <Palette className="w-5 h-5 transform group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300" />
                  </Button>
                </motion.div>
              </Link>
