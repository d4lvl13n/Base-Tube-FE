        ...
        <div>
          ...
          {channel?.title && (
            <div className="mb-4 p-3 bg-zinc-800 rounded-md">
              <div className="text-sm text-zinc-400">Connected Channel:</div>
          ...
          {!showConfirm ? (
            <button
              ...
              className="flex items-center px-4 py-2 text-sm bg-red-900/30 text-red-400 border border-red-900 rounded-md hover:bg-red-900/50 transition-colors"
            >
            ...
            <div className="border border-red-800 rounded-md p-3 bg-red-950/20">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  disabled={unlinking}
                  className="px-4 py-2 text-sm bg-red-700 text-white rounded-md hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={unlinking}
                  className="px-4 py-2 text-sm bg-zinc-800 text-white rounded-md hover:bg-zinc-700"
                >
                  Cancel
                </button>
              </div>
      ...
      {status === 'unlinked' && (
        <div>
          <div className="flex items-start mb-4">
            ...
            <div>
              <h4 className="font-medium text-amber-500">No YouTube channel yet</h4>
          ...
          <div className="mb-4 p-3 border border-zinc-700 rounded-md bg-zinc-800/50">
            <h5 className="font-medium mb-2 text-sm">Why connect?</h5>
          ...
          <button
            onClick={startOAuth}
            className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-500 transition-colors flex items-center"
          >
